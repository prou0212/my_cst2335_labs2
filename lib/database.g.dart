    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ToDoItem` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `quantity` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$TodoDAO extends TodoDAO {
  ...
  Future<void> delete(int id) async {
    await _queryAdapter
        .queryNoReturn('DELETE FROM ToDoItem WHERE id = ?1', arguments: [id]);
  }
